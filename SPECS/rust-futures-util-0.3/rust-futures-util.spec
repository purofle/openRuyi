...
Requires:       crate(%{pkgname})
Requires:       crate(memchr-2.0/default) >= 2.2
...
%files -n %{name}+async-await-macro

%files -n %{name}+channel

%files -n %{name}+compat

%files -n %{name}+default

%files -n %{name}+futures-channel

%files -n %{name}+futures-io

%files -n %{name}+futures-macro

%files -n %{name}+futures-sink

%files -n %{name}+futures-01

%files -n %{name}+io

%files -n %{name}+io-compat

%files -n %{name}+libc

%files -n %{name}+memchr

%files -n %{name}+portable-atomic
