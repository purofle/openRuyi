...
#!RemoteAsset:  sha256:85962cf0ce02e1e0a629cc34e7ca3e373ce20dda4c4d7294bbd0bf1fdb59e614
...
Requires:       crate(icu-locale-core-2.0) >= 2.1.1
...
Requires:       crate(icu-locale-core-2.0/alloc) >= 2.1.1
...
Requires:       crate(yoke-0.8/alloc) >= 0.8.1
Requires:       crate(yoke-0.8/derive) >= 0.8.1
Requires:       crate(zerofrom-0.1/alloc) >= 0.1.6
Requires:       crate(zerofrom-0.1/derive) >= 0.1.6
Requires:       crate(zerotrie-0.2/alloc) >= 0.2.3
...
Requires:       crate(%{pkgname})
Requires:       crate(writeable-0.6) >= 0.6.2
Requires:       crate(zerotrie-0.2) >= 0.2.3
...
Requires:       crate(serde-1.0/derive) >= 1.0.220
Requires:       crate(yoke-0.8/derive) >= 0.8.1
Requires:       crate(yoke-0.8/serde) >= 0.8.1
...
%files -n %{name}+deserialize-bincode-1

%files -n %{name}+deserialize-json

%files -n %{name}+deserialize-postcard-1

%files -n %{name}+export

%files -n %{name}+logging
