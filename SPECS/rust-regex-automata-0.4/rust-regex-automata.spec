...
%files -n %{name}+dfa-build

%files -n %{name}+hybrid

%files -n %{name}+internal-instrument-pikevm
...
%files -n %{name}+perf-literal

%files -n %{name}+perf-literal-multisubstring

%files -n %{name}+perf-literal-substring
...
%files -n %{name}+unicode-age

%files -n %{name}+unicode-bool

%files -n %{name}+unicode-case

%files -n %{name}+unicode-gencat

%files -n %{name}+unicode-perl

%files -n %{name}+unicode-script

%files -n %{name}+unicode-segment
